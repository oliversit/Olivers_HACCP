...
var CheesePages = require('./routes/CheeseForms');
var DeliPages = require('./routes/DeliForms');
var MeatPages = require('./routes/MeatForms');
...
app.use('/CheeseForms', CheesePages);
app.use('/DeliForms', DeliPages);
app.use('/MeatForms', MeatPages);
...
var departuser =req.body.userdepartment;
    ...
    connection.query("INSERT INTO `Submitted_Forms` (Date,Form_Name, Corection_ID, Column_1, Column_2, Column_3, Column_4, Column_5, Column_6, Column_7, Column_8, Column_9, Column_10, Column_11, Column_12, Column_13, Column_14, Column_15, Column_16, Column_17, Column_18, Column_19, Column_20, store, Department, Sign1, Sign2, SignDate1, SignDate2 ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )", [req.body.Date, req.body.Form_Name, req.body.Corection_ID, req.body.Column_1, req.body.Column_2, req.body.Column_3, req.body.Column_4, req.body.Column_5, req.body.Column_6, req.body.Column_7, req.body.Column_8, req.body.Column_9, req.body.Column_10, req.body.Column_11, req.body.Column_12, req.body.Column_13, req.body.Column_14, req.body.Column_15, req.body.Column_16, req.body.Column_17, req.body.Column_18, req.body.Column_19, req.body.Column_20, req.body.FormStore, req.body.userdepartment, req.body.Sign1, req.body.Sign2, req.body.SignDate1, req.body.SignDate2 ], function(err, result){
        if(err) throw err;
            console.log("Form inserted");
        });
	
        connection.query("INSERT INTO `Corrective_Actions` (Date, Form_Name, Corection_1, Corection_2, Corection_3, Corection_4, Corection_5, Corection_6, Corection_7, Corection_8, Corection_9, Corection_10, Corection_11, Corection_12, Corection_13, Corection_14, Corection_15, Corection_16, Corection_17, Corection_18, Corection_19, Corection_20, Corection_21, Corection_22, Corection_23, Corection_24, Corection_25, Corection_26, Corection_27, Corection_28, Corection_29, Corection_30, Corection_31, Corection_32, Corection_33, Corection_34, Corection_35, Corection_36, Corection_37, Corection_38, Corection_39, Corection_40, Corection_41, Corection_42, Corection_43, Corection_44, Corection_45, Corection_46, Corection_47, Corection_48, Corection_49, Corection_50, Corection_51, Corection_52, Corection_53, Corection_54, Corection_55, Corection_56, Corection_57, Corection_58, Corection_59, Corection_60, Corection_61, Corection_62, Corection_63, Corection_64, Corection_65, Corection_66, Corection_67, Corection_68, Corection_69, Corection_70, Corection_71, Corection_72, Corection_73, Corection_74, Corection_75, store, Department ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )", [req.body.Date, req.body.Form_Name, req.body.Corection_1, req.body.Corection_2, req.body.Corection_3, req.body.Corection_4, req.body.Corection_5, req.body.Corection_6, req.body.Corection_7, req.body.Corection_8, req.body.Corection_9, req.body.Corection_10, req.body.Corection_11, req.body.Corection_12, req.body.Corection_13, req.body.Corection_14, req.body.Corection_15, req.body.Corection_16, req.body.Corection_17, req.body.Corection_18, req.body.Corection_19, req.body.Corection_20, req.body.Corection_21, req.body.Corection_22, req.body.Corection_23, req.body.Corection_24, req.body.Corection_25, req.body.Corection_26, req.body.Corection_27, req.body.Corection_28, req.body.Corection_29, req.body.Corection_30, req.body.Corection_31, req.body.Corection_32, req.body.Corection_33, req.body.Corection_34, req.body.Corection_35, req.body.Corection_36, req.body.Corection_37, req.body.Corection_38, req.body.Corection_39, req.body.Corection_40, req.body.Corection_41, req.body.Corection_42, req.body.Corection_43, req.body.Corection_44, req.body.Corection_45, req.body.Corection_46, req.body.Corection_47, req.body.Corection_48, req.body.Corection_49, req.body.Corection_50, req.body.Corection_51, req.body.Corection_52, req.body.Corection_53, req.body.Corection_54, req.body.Corection_55, req.body.Corection_56, req.body.Corection_57, req.body.Corection_58, req.body.Corection_59, req.body.Corection_60, req.body.Corection_61, req.body.Corection_62, req.body.Corection_63, req.body.Corection_64, req.body.Corection_65, req.body.Corection_66,req.body.Corection_67, req.body.Corection_68, req.body.Corection_69, req.body.Corection_70, req.body.Corection_71, req.body.Corection_72, req.body.Corection_73, req.body.Corection_74, req.body.Corection_75, req.body.FormStore, req.body.userdepartment ], function(err, result){
        if(err) throw err;
...
var departuser =req.body.userdepartment;
    ...
    if (err) throw err;
	if (departuser=="Cheese") {
    res.render('Cheese/CheeseDashboard', { title: 'Dashboard', userData: data, userName: user, userDepartment: departuser, userId: datauserId, userStore: datastore, userRole: datausr, FormTitle: Title, FormBox: box});	
	}
	...
	else
		{
				...
				if (departuser=="Deli") {
    res.render('Deli/DeliDashboard', { title: 'Dashboard', userData: data, userName: user, userDepartment: departuser, userId: datauserId, userStore: datastore, userRole: datausr, FormTitle: Title, FormBox: box});	
	}
			
			else {
					if (departuser=="Meat") {
    res.render('Meat/MeatDashboard', { title: 'Dashboard', userData: data, userName: user, userDepartment: departuser, userId: datauserId, userStore: datastore, userRole: datausr, FormTitle: Title, FormBox: box});	
	}
...
var departuser =req.body.userdepartment;
    ...
    connection.query("INSERT INTO `Item_Maint` (Type, Name, Department, Location) VALUES (?,?,?,?)", [req.body.Type, req.body.Name, departselect, Storeselect], function(err, result){
        if(err) throw err;
...
var hash = bcrypt.hashSync(password, saltRounds);
    connection.query("INSERT INTO `Users` (firstname, lastname, userName, passwd, email, role, store, Department) VALUES (?,?,?,?, ?, ?, ?, ?)", [req.body.firstname, req.body.lastname, req.body.userName, hash, req.body.email, req.body.role, req.body.store, req.body.department], function(err, result){
        if(err) throw err;
            console.log("1 record inserted");
        });
    ...
    connection.query('SELECT  Id, userName, role, store FROM Users',   function(err, data, fields) {
		var form=req.body.Type
    if (err) throw err;
    res.render('User_List', { title: 'User_List', userData: data, formName: form, userName: user, userDepartment: departuser, userId: datauserId, userStore: datastore, userRole: datausr, FormTitle: Title});
